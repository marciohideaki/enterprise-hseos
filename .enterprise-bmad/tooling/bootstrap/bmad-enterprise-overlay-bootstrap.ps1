...
#
# Name: BMAD Enterprise Overlay Bootstrap Script
#
# ⚠️ GOVERNANCE SUPPORT TOOL
# ⚠️ MANUAL EXECUTION ONLY
#
# Purpose:
# Bootstrap the complete BMAD Enterprise Overlay structure,
...
Log "🚀 Bootstrapping BMAD Enterprise Overlay v1.4.0"
...
$Files = @(
    # Constitution
    "$Root\constitution\BMAD-Enterprise-Constitution.md",
    "$Root\constitution\BMAD-Enterprise-Constitution-Addendum.md",
...
Log "✅ BMAD Enterprise Overlay bootstrap completed."
Log "👉 Location: $Root"

...
**Status:** Mandatory  
**Scope:** All BMAD Agents before any execution  
**Version:** 1.0  
...
Before executing ANY task, BMAD Agents MUST confirm:

### 2.1 Governance Loaded
- [ ] BMAD Enterprise Constitution loaded
- [ ] Constitution Addendum loaded

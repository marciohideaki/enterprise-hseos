...
**Status:** Mandatory  
**Scope:** All documentation produced or modified by humans or BMAD agents  
**Version:** 1.0  

---

## 1. Purpose
This policy defines **how documentation is written, structured, versioned, and governed** in an Enterprise BMAD environment.
...
- `/enterprise-bmad/` → Enterprise governance, policies, agent rules

# PM Agent — Constraints (Enterprise Overlay)
...
The PM Agent MUST shard PRDs when:
...
The PM Agent MUST ensure that PRDs explicitly address:
...
## 8. Acceptance
By producing output, the PM Agent accepts these constraints as binding.

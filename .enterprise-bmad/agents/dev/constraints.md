# Developer Agent — Constraints (Enterprise Overlay)
**Agent:** Developer  
...
The Developer Agent MUST shard when:
...
The Developer Agent MUST enforce:
...
## 8. Acceptance
By producing output, the Developer Agent accepts these constraints as binding.

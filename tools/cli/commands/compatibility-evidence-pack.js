...
module.exports = {
  ...
  description: 'Package real downstream release-window artifacts without touching operational state.',
  options: [
    ['--manifest <absolute-path>', 'Canonical downstream collection manifest'],

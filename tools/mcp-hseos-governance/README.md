...
> **Status: scaffolded.** Implementation lands as a follow-up PR within Wave 3. Declared in `.agents/mcp/bundles/core.yaml`.
...
- `index.js` — MCP server entrypoint using `@modelcontextprotocol/sdk`

...
DB_PATH = Path(os.environ.get("HSEOS_USAGE_DB", str(Path.home() / ".claude" / "usage.db")))
...
Environment variables:
  HOST               Dashboard bind host (default: localhost)
  PORT               Dashboard port (default: 8080)
  HSEOS_USAGE_DB     Path to SQLite database (default: ~/.claude/usage.db)
"""

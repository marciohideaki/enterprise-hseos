...
tier: full
source: .enterprise/governance/agent-skills/verification-before-completion/SKILL.md
quick: .enterprise/governance/agent-skills/verification-before-completion/SKILL-QUICK.md
portable: true
license: Apache-2.0
---
...
For low-context activation, load `.enterprise/governance/agent-skills/verification-before-completion/SKILL-QUICK.md` or `QUICK.md` first. Load this full skill for deep analysis, violation fixing, or formal review gates.

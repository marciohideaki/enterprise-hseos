...
tier: full
source: .enterprise/governance/agent-skills/threat-modeling/SKILL.md
quick: .enterprise/governance/agent-skills/threat-modeling/SKILL-QUICK.md
portable: true
license: MIT
---
...
For low-context activation, load `.enterprise/governance/agent-skills/threat-modeling/SKILL-QUICK.md` or `QUICK.md` first. Load this full skill for deep analysis, violation fixing, or formal review gates.

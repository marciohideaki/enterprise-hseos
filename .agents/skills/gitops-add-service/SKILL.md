...
tier: full
source: .enterprise/governance/agent-skills/gitops-add-service/SKILL.md
quick: .enterprise/governance/agent-skills/gitops-add-service/SKILL-QUICK.md
portable: true
license: Apache-2.0
---
...
For low-context activation, load `.enterprise/governance/agent-skills/gitops-add-service/SKILL-QUICK.md` or `QUICK.md` first. Load this full skill for deep analysis, violation fixing, or formal review gates.

...
tier: full
source: .enterprise/governance/agent-skills/multi-agent-orchestration/SKILL.md
quick: .enterprise/governance/agent-skills/multi-agent-orchestration/SKILL-QUICK.md
portable: true
---
...
For low-context activation, load `.enterprise/governance/agent-skills/multi-agent-orchestration/SKILL-QUICK.md` or `QUICK.md` first. Load this full skill for deep analysis, violation fixing, or formal review gates.

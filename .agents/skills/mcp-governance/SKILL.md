...
tier: full
source: .enterprise/governance/agent-skills/mcp-governance/SKILL.md
quick: .enterprise/governance/agent-skills/mcp-governance/SKILL-QUICK.md
portable: true
---
...
For low-context activation, load `.enterprise/governance/agent-skills/mcp-governance/SKILL-QUICK.md` or `QUICK.md` first. Load this full skill for deep analysis, violation fixing, or formal review gates.

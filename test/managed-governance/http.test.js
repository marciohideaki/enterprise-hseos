...
test('every designed endpoint returns the canonical v1 envelope', async () => {
  ...
  const endpoints = [
    ...
    ['GET', '/api/v1/context?limit=10&repository_id=repository-1'],
    ['GET', '/api/v1/releases/release-1'],
    ['POST', '/api/v1/releases/diff', { base_release_id: 'release-1', target_release_id: 'release-2' }],
    ['POST', '/api/v1/snapshots/verify', { snapshot_id: '00000000-0000-4000-8000-000000000001' }],

...
adversarial_review_task: '{project-root}/.hseos/core/tasks/review-adversarial-general.xml'
---
...
- `installed_path` = `{project-root}/.hseos/hsm/workflows/hseos-quick-flow/quick-dev-new-preview`

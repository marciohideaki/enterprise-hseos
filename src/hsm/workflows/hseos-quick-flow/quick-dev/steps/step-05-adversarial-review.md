...
```xml
<invoke-task>Review {diff_output} using {project-root}/.hseos/core/tasks/review-adversarial-general.xml</invoke-task>
```
...
With findings in hand, read fully and follow: `{project-root}/.hseos/hsm/workflows/hseos-quick-flow/quick-dev/steps/step-06-resolve-findings.md` for user to choose resolution approach.

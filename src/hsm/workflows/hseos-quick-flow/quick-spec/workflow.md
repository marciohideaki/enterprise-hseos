...
main_config: '{project-root}/.hseos/hsm/config.yaml'
...
quick_dev_workflow: '{project-root}/.hseos/hsm/workflows/hseos-quick-flow/quick-dev/workflow.md'
---
...
Read fully and follow: `{project-root}/.hseos/hsm/workflows/hseos-quick-flow/quick-spec/steps/step-01-understand.md` to begin the workflow.

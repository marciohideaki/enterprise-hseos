...
- Read fully and follow: {project-root}/.hseos/core/workflows/advanced-elicitation/workflow.xml with the current context analysis
...
- Read fully and follow: {project-root}/.hseos/core/workflows/party-mode/workflow.md with the current project context
...
- Load `{project-root}/.hseos/hsm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.hseos/hsm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md` to evaluate starter template options.

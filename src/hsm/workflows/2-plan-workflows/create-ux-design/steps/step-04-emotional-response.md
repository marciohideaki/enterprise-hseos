...
- Read fully and follow: {project-root}/.hseos/core/workflows/advanced-elicitation/workflow.xml with the current emotional response content
...
- Read fully and follow: {project-root}/.hseos/core/workflows/party-mode/workflow.md with the current emotional response definition
...
- Load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-05-inspiration.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-05-inspiration.md` to analyze UX patterns from inspiring products.

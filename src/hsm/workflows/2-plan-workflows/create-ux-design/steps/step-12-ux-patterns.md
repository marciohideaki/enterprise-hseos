...
- Read fully and follow: {project-root}/.hseos/core/workflows/advanced-elicitation/workflow.xml with the current UX patterns content
...
- Read fully and follow: {project-root}/.hseos/core/workflows/party-mode/workflow.md with the current UX patterns
...
- Load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-13-responsive-accessibility.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-13-responsive-accessibility.md` to define responsive design and accessibility strategy.

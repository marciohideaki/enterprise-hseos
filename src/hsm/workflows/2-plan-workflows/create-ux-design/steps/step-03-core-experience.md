...
- Read fully and follow: {project-root}/.hseos/core/workflows/advanced-elicitation/workflow.xml with the current core experience content
...
- Read fully and follow: {project-root}/.hseos/core/workflows/party-mode/workflow.md with the current core experience definition
...
- Load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-04-emotional-response.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-04-emotional-response.md` to define desired emotional responses.

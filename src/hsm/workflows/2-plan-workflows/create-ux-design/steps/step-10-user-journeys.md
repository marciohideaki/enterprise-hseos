...
- Read fully and follow: {project-root}/.hseos/core/workflows/advanced-elicitation/workflow.xml with the current user journey content
...
- Read fully and follow: {project-root}/.hseos/core/workflows/party-mode/workflow.md with the current user journeys
...
- Load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md` to define component library strategy.

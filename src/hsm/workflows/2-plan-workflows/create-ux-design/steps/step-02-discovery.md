...
- Load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-03-core-experience.md`

## APPEND TO DOCUMENT:

When user selects 'C', append the content directly to the document. Only after the content is saved to document, read fully and follow: `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-03-core-experience.md`.

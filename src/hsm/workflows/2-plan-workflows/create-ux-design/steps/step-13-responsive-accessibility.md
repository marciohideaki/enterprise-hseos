...
- Read fully and follow: {project-root}/.hseos/core/workflows/advanced-elicitation/workflow.xml with the current responsive/accessibility content
...
- Read fully and follow: {project-root}/.hseos/core/workflows/party-mode/workflow.md with the current responsive/accessibility strategy
...
- Load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-14-complete.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-ux-design/steps/step-14-complete.md` to finalize the UX design workflow.

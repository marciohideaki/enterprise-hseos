...
Detect if PRD follows HSEOS format and route appropriately - classify as HSEOS Standard / HSEOS Variant / Non-Standard, with optional parity check for non-standard formats.
...
### 2. Check for HSEOS PRD Core Sections

Check if the PRD contains the following HSEOS PRD core sections:
...
- Follows HSEOS PRD structure closely

**HSEOS Variant:**
- 3-4 core sections present
- Generally follows HSEOS patterns but may have structural differences
- Missing some sections but recognizable as HSEOS-style

**Non-Standard:**
- Fewer than 3 core sections present
- Does not follow HSEOS PRD structure
...
**Format Classification:** [HSEOS Standard / HSEOS Variant / Non-Standard]
**Core Sections Present:** [count]/6
```

### 5. Route Based on Format Classification

**IF format is HSEOS Standard or HSEOS Variant:**
...
**[A] Parity Check** - Analyze gaps and estimate effort to reach HSEOS PRD parity
...
- HSEOS core sections checked systematically
- Format classified correctly based on section count
- Findings reported to validation report
- HSEOS Standard/Variant PRDs proceed directly to next validation step

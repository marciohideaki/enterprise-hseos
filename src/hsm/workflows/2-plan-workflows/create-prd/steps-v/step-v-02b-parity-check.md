...
description: 'Document Parity Check - Analyze non-standard PRD and identify gaps to achieve HSEOS PRD parity'
...
Analyze non-standard PRD and identify gaps to achieve HSEOS PRD parity, presenting user with options for how to proceed.
...
- ✅ You bring HSEOS PRD standards expertise and gap analysis
...
- 🎯 Analyze each HSEOS PRD section for gaps
...
### 1. Analyze Each HSEOS PRD Section

For each of the 6 HSEOS PRD core sections, analyze:
...
**Overall Effort to Reach HSEOS Standard:** [Quick/Moderate/Substantial]
...
Your PRD is missing {count} of 6 core HSEOS PRD sections. The overall effort to reach HSEOS standard is: **{effort level}**
...
- All 6 HSEOS PRD sections analyzed for gaps

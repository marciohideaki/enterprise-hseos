...
- HSEOS PRD standards: Load from prd-purpose.md

**Tasks:**
1. Read current PRD section
2. Apply specified changes
3. Ensure HSEOS PRD principles compliance:
...
- Restructuring: Reformat content to HSEOS standard
...
**For restructuring:**
- Reorganize PRD to HSEOS standard structure
- Ensure proper ## Level 2 headers
- Reorder sections logically
- Update PRD frontmatter to match HSEOS format

**Follow HSEOS PRD structure:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
HSEOS standard structure applied.

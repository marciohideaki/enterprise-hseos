...
Analyze legacy PRD against HSEOS standards, identify gaps, propose conversion strategy, and let user choose how to proceed.
...
- ✅ You bring HSEOS standards expertise and conversion guidance
...
- 🎯 Analyze legacy PRD against HSEOS standard
...
**For each HSEOS PRD section, analyze:**
...
- Manually check PRD for each HSEOS section
...
**[R] Restructure to HSEOS** - Full conversion to HSEOS format, then apply your edits
...
- All 6 HSEOS core sections analyzed for gaps

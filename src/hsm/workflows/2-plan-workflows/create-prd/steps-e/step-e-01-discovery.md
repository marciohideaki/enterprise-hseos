...
prdPurpose: '{project-root}/.hseos/hsm/workflows/2-plan-workflows/create-prd/data/prd-purpose.md'
advancedElicitationTask: '{project-root}/.hseos/core/workflows/advanced-elicitation/workflow.xml'
partyModeWorkflow: '{project-root}/.hseos/core/workflows/party-mode/workflow.md'
---
...
- 🎯 Detect PRD format (HSEOS/legacy)
...
This file defines what makes a great HSEOS PRD. Internalize this understanding - it will guide improvement recommendations.
...
- Convert to HSEOS format (if legacy PRD)
...
**Check for HSEOS PRD core sections:**
1. Executive Summary
2. Success Criteria
3. Product Scope
4. User Journeys
...
**Classify format:**
- **HSEOS Standard:** 5-6 core sections present
- **HSEOS Variant:** 3-4 core sections present, generally follows HSEOS patterns
- **Legacy (Non-Standard):** Fewer than 3 core sections, does not follow HSEOS structure

### 8. Route Based on Format and Context

**IF validation report provided OR PRD is HSEOS Standard/Variant:**
...
This PRD does not follow HSEOS standard structure (only {count}/6 core sections present).
...
**[C] Convert to HSEOS Format** - Convert PRD to HSEOS standard structure, then apply your edits
...
- HSEOS PRDs proceed directly to review step

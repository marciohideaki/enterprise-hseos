...
- When 'A' selected: Execute {project-root}/.hseos/core/workflows/advanced-elicitation/workflow.xml
- When 'P' selected: Execute {project-root}/.hseos/core/workflows/party-mode
...
After completing all rule categories and user selects 'C' for the final category, load `{project-root}/.hseos/hsm/workflows/generate-project-context/steps/step-03-complete.md` to finalize the project context file.

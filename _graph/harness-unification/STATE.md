...
- **Observation:** healthy 4/4 server heartbeat coverage and a valid release manifest; 2026-08-24 contains legacy use from pre-change sessions and is excluded; progress remains 0/30 complete zero-use days

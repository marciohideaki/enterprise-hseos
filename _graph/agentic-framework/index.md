...
| `state/checkpoints/A10-A11-deepseek-one-shot-composition.md`                    | Hash-bound tool-free DeepSeek composition and one-shot semantics        | Partial profile evidence; sandboxed CLI remains open          |
...
| `state/checkpoints/A15-A20-claude-code-hardening.md`                            | Seven-proposal implementation disposition and adversarial closeout      | Accepted post-reference hardening evidence                    |
| `CLAUDE-CODE-HARDENING-DISPOSITION.json`                                       | Canonical machine-verifiable seven-proposal verdict catalog             | A21 disposition source                                        |
| `../../test/test-agentic-hardening-conformance.js`                              | Exact verdict, public-surface and no-cutover regression lock            | Deterministic A21 conformance                                 |

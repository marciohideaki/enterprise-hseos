...
| A10  | Hosted coding-agent and external ACP adapters                                                           | A9                          | adapter-specific manifests and declared-level suites; external smokes when available                                                  | No secret access; unsupported capability remains explicit           |

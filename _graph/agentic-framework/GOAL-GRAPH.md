...
- Public bound-profile execution remains unavailable until an external supervisor can produce and verify the required `ai-jail` lockdown attestation; tests inject the attestation boundary and do not claim a live sandbox.

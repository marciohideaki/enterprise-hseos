...
- **Next reversible action:** continue collecting complete zero-use G9 days; merge of the complete tracked registry, its publication in a new release and collection of real R/R+1 evidence remain separately gated
...
- **A13 canonical registry source:** the exact owner-approved bytes are prepared at the tracked registry path for a future release, without merge, push, publication, observation-manifest change, collection or activation

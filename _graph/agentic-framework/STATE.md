...
- **Operational constraint:** existing host authentication and provider network routes were exercised only for the explicitly authorized delegated L0 smokes; the sandbox-supervised activation candidate remains unexercised; G9 compatibility evidence and separate human authorization remain prerequisites for activation, together with the final stable audit

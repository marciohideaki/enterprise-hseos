...
- **Correctness Over Speed**: Fast is good, correct is better.

---

## tasks/ Convention

When adopted in a project, create a `tasks/` directory at the repo root:
...
- Verified by: <how correctness was demonstrated>
```

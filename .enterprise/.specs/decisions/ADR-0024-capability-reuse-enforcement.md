# ADR-0024 — Capability Reuse Enforcement Complementing the Capability Graph
...
Creating a competing registry or ownership model would violate ADR-0022. The missing layer is

...
**Status:** Mandatory  
**Scope:** All repositories using Enterprise Overlay  
**Version:** 1.0  

---

## 1. Purpose
This model defines how CI/CD pipelines enforce Enterprise governance automatically.
...
- Exceptions live in `/.enterprise/exceptions/`

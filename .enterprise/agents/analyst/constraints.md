# Analyst Agent — Constraints (Enterprise Overlay)
**Agent:** Analyst  
...
The Analyst Agent MUST shard requirements when:
...
The Analyst Agent MUST always consider:
...
## 8. Acceptance
By producing output, the Analyst Agent accepts these constraints as binding.

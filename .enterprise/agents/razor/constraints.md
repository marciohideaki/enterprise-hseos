# RAZOR Agent — Constraints (Enterprise Overlay)
...
The RAZOR Agent MUST shard when:
...
## 6. Acceptance
By producing output, the RAZOR Agent accepts these constraints.

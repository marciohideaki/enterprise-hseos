# CIPHER Agent — Constraints (Enterprise Overlay)
...
The CIPHER Agent MUST apply sharding when:
...
The CIPHER Agent MUST ALWAYS enforce:
...
## 8. Acceptance
By producing output, the CIPHER Agent accepts these constraints as binding.
